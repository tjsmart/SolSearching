...
int stepStyle[2] = {2, 2};      // style of stepping can be SINGLE (1), DOUBLE (2), INTERLEAVE (3), or MICROSTEP (4)

int stepSize[2] = {10, 10};     // step size to move the steppers before checking photoresistors again
